    ...
    <div class="main-container">
        ...
        <div id="analytics" class="page">
            <div class="page-header">
                ...
                <p>Visual insights into trend performance</p>
            </div>
    ...
    <script>
        ...
        function renderScoreChart(distribution) {
            ...
            labels.forEach(function(label, index) {
                ...
                if (label === "90-100") color = "#10b981";
                else if (label === "80-89") color = "#667eea";
                else if (label === "70-79") color = "#f59e0b";
                else if (label === "60-69") color = "#f97316";
                else color = "#ef4444";
        ...
        function renderStageChart(stages) {
            ...
            labels.forEach(function(label, index) {
                ...
                if (label.indexOf("Early") >= 0) color = "#f59e0b";
                else if (label.indexOf("Emerging") >= 0) color = "#ef4444";
                else if (label.indexOf("Rising") >= 0) color = "#667eea";
                else if (label.indexOf("Peak") >= 0) color = "#10b981";
                else color = "#6b7280";
